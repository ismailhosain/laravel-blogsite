...
<div class="col-md-3 card p-2 m-4 bg-light" style="width:280px">
  ...
  <div class="card-body">
    ...
    <!-- total service -->
    <div class="col-md-3 card p-2 m-4 bg-primary" style="width:280px">
      <img class="card-img-top" style="width:100%">
      <div class="card-body">
        <h4 class="card-title text-white">{{$servicecount}}</h4>
        <p class="card-text text-white">Total Services</p>
      </div>
    </div>
    <!-- total course -->
    <div class="col-md-3 card p-2 m-4 bg-info" style="width:280px">
      <img class="card-img-top" style="width:100%">
      <div class="card-body">
  ...
  <div class="row text-center">
    <!-- total Project -->
    <div class="col-md-3 card p-2 m-4 bg-success" style="width:280px">
      <img class="card-img-top" style="width:100%">
      <div class="card-body">
    ...
    <!-- total Contacts -->
    <div class="col-md-3 card p-2 m-4 badge-warning" style="width:280px">
      <img class="card-img-top" style="width:100%">
      <div class="card-body">
